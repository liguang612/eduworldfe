    ...
    <div className="bg-white shadow-md rounded-lg p-4 mb-6">
      <div className="flex items-center justify-between mb-3">
        <div className="flex items-center space-x-3">
          <img src={avatarSrc} alt={userName} className="h-10 w-10 rounded-full flex-shrink-0 object-cover" />
          <div>
            <p className="font-semibold text-gray-800 hover:underline cursor-pointer">{userName}</p>
